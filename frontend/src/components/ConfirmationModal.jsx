  ...
  return (
    <>
      <Button
        type="button"
        onClick={openModal}
        className="font-spaceGrotesk flex justify-center py-2 px-4 border-2 rounded-lg shadow-sm text-sm font-medium text-prim transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-secondary-500"
      >
        Authenticate
      </Button>
