      ...
      <div className="w-full flex flex-col justify-evenly gap-10 xl:flex-row">
        ...
        <div className="flex flex-col">
          <div className="flex flex-col gap-5 flex-wrap items-center">
            ...
            {/* Product Image */}
            <div className="xl:hidden mb-4 p-10 bg-white border border-[#CDDBFF] rounded-[17px]">
              <img
                src={product.image}
                alt={product.title}
                className="object-contain"
            ...
            <div className="flex items-center flex-col">
              <div className="flex items-center gap-6 py-6 border-y border-y-[#E4E4E4]">
                <div className="flex flex-col gap-2">
                  <p className="text-[24px] md:text-[32px] text-secondary font-bold">
                    {product.currency} {product.currentPrice}
                  </p>
                  <p className="text-[14px] md:text-[21px] text-black opacity-50 line-through">
